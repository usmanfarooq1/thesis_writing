...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\linewidth]{figures/preprocessing_pipeline.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/precipitation_raster_thesis.png}
...
\ref{fig:proj-string-mercator} mercator
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\linewidth]{figures/proj_string_mercator.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/merc.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/d_reprojection_example.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/raster_interpolation.png}
