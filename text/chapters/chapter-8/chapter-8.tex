...
The five cylindrical map projections used for the expertimention are Mercator, Plate Carree, Cylindrical Equal Area, General Oblique Transformation, and Transverse Cylindrical Equal Area. The selection of the map projections in done based on the underlying properties of the cylindrical map projections.
